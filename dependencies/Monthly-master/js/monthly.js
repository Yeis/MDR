...
(function($) {
	$.fn.extend({
		...
		function setMonthly(m, y){
            ...
            else if(options.mode == 'json-events')
            {
		...
		$(document.body).on('click', '#'+uniqueId+' a.monthly-day', function (e) {
            ...
            //EVENTO QUE APARECE AL HACERLE CLICK A UN BOTON
			if(options.mode == 'event' && options.eventList == true) {
				var whichDay = $(this).data('number');
                 var anterior =  $('#' + uniqueId+' .monthly-event-list').data("past-value")
                //MONTHLY-EVENT-LIST IS THE LAYOUT OF THE EVENT THERE I MUST NEED TO SET
				$('#' + uniqueId+' .monthly-event-list').data("past-value",whichDay);
				$('#' + uniqueId+' .monthly-event-list').show();
				$('#' + uniqueId+' .monthly-event-list').css('transform');
				$('#' + uniqueId+' .monthly-event-list').css('transform','scale(1)');
				$('#'+uniqueId+' .monthly-list-item[data-number="'+whichDay+'"]').show();
                //codigo para borrar la fecha seleccionada anteriormente 
                $('#'+uniqueId+' .monthly-list-item[data-number="'+anterior+'"]').hide();
                //Agregar button 
                $('#' + uniqueId+' .monthly-event-list').append("<button id='AddCita' type='button' onclick='alert('Es Tiempo de Hacer una Cita')' >Make Appointment</button>");
                //fin de codigo para borrar fecha 
				...
				viewToggleButton();
			// If picker, pick date  ESTA PARTE NO NOS IMPORTA YA QUE SOLO ES PARA EL PICKER
            //==========================================================================================================
